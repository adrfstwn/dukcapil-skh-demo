          ...
          <div class="flex flex-col md:flex-row justify-between md:gap-6">
              ...
              <div class="flex flex-col gap-6 md:gap-12">
                <div class="flex flex-col gap-6 ">
                  <div class="flex flex-col gap-2">
                    <h2 class="font-monserrat font-bold text-2xl md:text-[32px] text-primary_teks "> Formulir Pendaftaran
                  ...
                  <div class="flex flex-col gap-4">
                    ...
                    <p class="font-nunito text-base text-primary_teks">Lorem ipsum dolor sit amet, consectetur adipiscing
                      elit. Ut et massa mi. Aliquam in hendrerit urna. Pellentesque sit amet sapien fringilla, mattis ligula
                      consectetur,. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut et massa mi. Aliquam in
                      hendrerit urna. Pellentesque sit amet sapien fringilla, mattis ligula consectetur, Lorem ipsum dolor
                      sit amet, consectetur adipiscing elit. Ut et massa mi. Aliquam in hendrerit urna.
                    </p>
                    <button class="px-2 py-[4px] font-nunito text-sm text-background_light bg-primary rounded-sm max-w-60">
                    ...
                    <div class="flex">
                      <div class="flex  gap-3">
                        ...
                        <a href="http://www.youtube.com/@disdukcapilkab.sukoharjo6228" class="">
                          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" class="md:size-8"
                            viewBox="0,0,256,256" style="fill:#000000;">
                            <g fill="#9E0000" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt"
                        ...
                        <a href="https://www.instagram.com/disdukcapilkabsukoharjo/" class="">
                          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" class="md:size-7"
                            viewBox="0,0,256,256" style="fill:#000000;">
                            <g fill="#9E0000" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt"
                              stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0"
                              font-family="none" font-weight="none" font-size="none" text-anchor="none"
            ...
            <aside class="md:block md:border-l-[2px] border-gray-200 md:pl-6">
              ...
              <div class="flex flex-col py-3 gap-4">
                <div class="flex flex-col gap-2">
                  <a href="" class="font-nunito text-base font-semibold text-primary_teks line-clamp-2">Persyaratan
                    Pencatatan
                    Pengangkatan Anak</a>
