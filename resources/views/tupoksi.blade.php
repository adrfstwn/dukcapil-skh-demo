            ...
            <div class="grid gap-10">
                <div class="grid grid-cols-1 gap-4 md:gap-0 md:grid-cols-2">
                    ...
                    @foreach ($tupoksis as $tupoksi)
                        ...
                        <div class="flex flex-col gap-4">
                            <h3 class="font-monserrat text-primary_teks text-xl font-semibold md:text-2xl">{{ $tupoksi->nama_fungsi }}</h3>
                            <hr class="w-7 border-b-[1.5px] border-primary rounded-sm">
                ...
                <div class="grid grid-cols-1 gap-4 md:gap-0 md:grid-cols-2">
                    <div class="flex">
                        <h2 class="font-monserrat text-primary text-2xl font-bold md:text-[32px]">{{ $tupoksi->nama_visimisi }}</h2>
                    </div>
                    <div class="flex flex-col gap-6">
                        <div class="flex flex-col gap-4">
                            <h3 class="font-monserrat text-primary_teks text-xl font-semibold md:text-2xl">{{ $tupoksi->nama_visi }}</h3>
                            <hr class="w-7 border-b-[1.5px] border-primary rounded-sm">
                            <p class="font-nunito text-base text-primary_teks font-bold"><i>{{ $tupoksi->deskripsi_visi }}</i>
                            </p>
                        </div>
                        <div class="flex flex-col gap-4">
                            <h3 class="font-monserrat text-primary_teks text-xl font-semibold md:text-2xl">{{ $tupoksi->nama_misi }}</h3>
                            <hr class="w-7 border-b-[1.5px] border-primary rounded-sm">
