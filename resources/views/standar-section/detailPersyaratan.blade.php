          ...
          <div class="flex flex-col md:flex-row justify-between md:gap-6">
            <div class="flex flex-col gap-12"> 
              ...
              <div class="flex flex-col gap-4">
                <h2 class="font-monserrat text-2xl md:text-[32px] text-primary_teks pt-6 md:pt-0 border-b-2 pb-4"><span
                    class="font-bold text-primary ">Berita</span> Terbaru</h2>
                <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                  <div class="flex flex-col gap-y-3">
                    ...
                    <a href="" class="text-base font-bold font-nunito text-primary_teks line-clamp-2">Forum Perangkat Daerah Dinas
