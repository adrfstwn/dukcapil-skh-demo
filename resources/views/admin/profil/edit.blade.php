...
@section('content')
    <section id="profil-edit">
        <div class="container">
            <div class="flex flex-col p-6 border-[1.5px] border-white shadow-md bg-slate-50 rounded-2xl shadow-gray-200">
                <div class="flex flex-col">
                    <h2 class="text-2xl font-bold md:text-3xl font-monserrats text-primary_teks">Edit Profil Section</h2>
                ...
                <form action="{{ route('profil.update', ['id' => $profil->id]) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="my-2">
                        ...
                        <input type="text" name="nama" value="{{ $profil->nama }}" id="nama-input"
