        ...
        <div class="container">
            <div
                ...
                <div class="flex flex-col">
                    <h2 class="text-2xl font-bold md:text-3xl font-monserrats text-primary_teks">Edit Map Section</h2>
                    <p class="text-base text-secondary_teks">Input for map section</p>
                </div>
                <form action="{{ route('map.update', ['id' => $map->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                <div class="my-2">
                    <label for="alamat-input" class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Alamat</label>
                    <input type="text" name="alamat" value="{{ $map->alamat }}" id="alamat-input"
                ...
                <div class="my-2">
                    ...
                    <input type="url" name="link_map" value="{{ $map->link_map }}" id="link-map-input"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary dark:focus:border-primary">
                </div>
                    @if ($errors->any())
