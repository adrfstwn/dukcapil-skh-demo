        ...
        <div class="container">
            <div
                ...
                <form action="{{ route('download.update', $download->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="my-2">
                        <label for="deskripsi_download"
                            class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Description Download
                            Document</label>
                        <textarea id="deskripsi_download" name="deskripsi_download" rows="4"
                            ...
                            placeholder="Write your thoughts here...">{{ $download->deskripsi_download }}</textarea>
                    </div>
                    <div class="my-2">
