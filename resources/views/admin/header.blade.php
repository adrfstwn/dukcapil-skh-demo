<!-- sidenav  -->
<<<<<<< HEAD
<aside class="max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-6 ml-4 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased shadow-none md:transition-transform duration-200 xl:left-0 translate-x-0 xl:bg-transparent">
  <div class="h-19.5">
    <i class="absolute top-0 right-0 hidden p-4 opacity-50 cursor-pointer fas fa-times text-slate-400 xl:hidden" sidenav-close></i>
    <a class="block flex flex-col px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700" href="javascript:;" target="_blank">
      <img src="./dist/assets/image/Logo-header.png" class="inline h-full w-16 transition-all duration-200 ease-nav-brand max-h-8" alt="main_logo" />
  ...
  <div class="">
    <ul class="flex flex-col pl-0 mb-0">
      <li class="mt-0.5 w-full">
        <a class="py-2.7 shadow-soft-xl text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg bg-white px-4 font-semibold text-slate-700 transition-colors" href="{{route('homeslider.index')}}">
...
<aside
    ...
    <div class="h-19.5">
        ...
        <a class="block flex flex-col px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700" href="javascript:;"
            ...
            <span class="ml-1 font-semibold transition-all duration-200 ease-nav-brand">ADMIN DISDUKCAPIL SKH</span>
>>>>>>> 325dbb6c2e200e7ba8a1a17e593d9bc95c7ea666
        </a>
    </div>
