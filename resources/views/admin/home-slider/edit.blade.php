    ...
    <section id="home-slider-edit">
        <div class="container">
            <div
                ...
                <form action="{{ route('homeslider.update', ['id' => $homeSlider->id]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                <div class="my-2">
                    <label for="default-input" class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Title
                        news slider</label>
                    <input type="text" id="judul" name="judul" value="{{ $homeSlider->judul }}"
                ...
                <div class="my-2">
                    <label for="default-input"
                        ...
                        slider</label>
                    <input type="text" id="deskripsi" name="deskripsi" value="{{ $homeSlider->deskripsi }}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary dark:focus:border-primary">
                </div>
                ...
                <input
                    ...
                    aria-describedby="file_input_help" id="file_input" type="file" name="gambar_slider">
