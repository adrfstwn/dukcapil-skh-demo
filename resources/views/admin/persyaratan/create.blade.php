...
@section('content')
        ...
        <div class="container">
            <div class="flex flex-col p-6 border-[1.5px] border-white shadow-md backdrop-blur-md bg-slate-50 rounded-2xl shadow-gray-200">
                <div class="flex flex-col">
                    ...
                    <p class="text-base text-secondary_teks">Input for persyaratan section</p>
                </div>
    ...
    @endforeach
                    ...
                    <div class="my-2">
                        ...
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="file_input_help">File Boleh Gambar atau Document.</p>
                    </div>
                    @if ($errors->any())
