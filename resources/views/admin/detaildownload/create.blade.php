...
@section('content')
    <section id="detaildownload-create">
        <div class="container">
            <div class="flex flex-col p-6 border-[1.5px] border-white shadow-md bg-slate-50 rounded-2xl shadow-gray-200">
                <div class="flex flex-col">
                    <h2 class="text-2xl font-bold md:text-3xl font-monserrats text-primary_teks">Create Detail Download Section</h2>
                    <p class="text-base text-secondary_teks">Input for detail download section</p>
                </div>
                <form action="{{ route('detaildownload.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="my-2">
