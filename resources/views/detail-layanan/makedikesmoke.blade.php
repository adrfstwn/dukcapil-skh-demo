...
@section('content')
    ...
    <section id="makedikesmoke" class="my-10 md:my-20 -z-10">
        <div class="container">
                    ...
                    <div class="flex flex-col gap-6 md:gap-12">
                        <div class="flex flex-col gap-6 ">
                            <div class="flex flex-col gap-2">
                                <h2 class="font-monserrat font-bold text-2xl md:text-[32px] text-primary_teks "> Melayani
                                    Administrasi Kependudukan di Kecamatan Semakin Oke
                                </h2>
                            ...
                            <div class="flex flex-col gap-4 max-w-screen-md">
                                <img src="dist/assets/image/Karyawan.jpg" alt="foto kegiatan karyawan"
                                    class="rounded-md ">
                                <p class="font-nunito text-base md:text-lg text-primary_teks">Pelayanan 
                                    Akta Kelahiran Umum (60 hari)
                                    Akta Kematian Reguler (30 hari)
                                    Pindah antar DesaKecamatan
                                    Kartu Keluarga
                                    Cetak KIA
                                    Perekaman KTP-el
                                    Aktivasi IKD
